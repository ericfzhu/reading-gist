...
exports.updateGist = void 0;
var dotenv = require("dotenv");
var Octokit = require("@octokit/core").Octokit;
dotenv.config();
var octokit = new Octokit({ auth: process.env.GH_TOKEN });
function updateGist(title, content) {
    return __awaiter(this, void 0, void 0, function () {
        var gist_id, gist, filename;
        var _a;
